...
/*   Updated: 2023/10/18 13:04:15 by alaparic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	while (y++ < SCREEN_HEIGHT)
	{
		...
		while (x++ < SCREEN_WIDTH)
		{
			if (y < SCREEN_HEIGHT / 2)
				ft_put_pixel(game->img, x, y, ft_rgba(floor.red, floor.green, floor.blue, 0));
			else
				ft_put_pixel(game->img, x, y, ft_rgba(ceiling.red, ceiling.green, ceiling.blue, 0));
		}
	}
}
